...
const BindingRecord = DbbObject.extend({
    ...
    UI: {
      ...
      checked: {
        get: ($el, field, dataKey)=>$el.prop('checked'),
        set: ($el, field, value, dataKey)=>{
      ...
      selected: {
        get: ($el, field, dataKey)=>_.find($el.find('option'), option=>option.selected===true).value,
        set: ($el, field, value, dataKey)=>{
      ...
      option: {
        get: ($el, field, dataKey)=>_.find($el.find('option'), option=>option.selected===true).innerHTML,
        set: ($el, field, value, dataKey)=>{
      ...
      radio: {
        get: ($el, field, dataKey)=>_.find($el, el=>el.checked===true).value,
        set: ($el, field, value, dataKey)=>{
      ...
      text: {
        get: ($el, field, dataKey)=>$el.html(),
        set: ($el, field, value, dataKey)=>($el.html() !== value) && $el.html(value)
      },
      prop: {
        get: ($el, field, dataKey)=>$el.prop(field),
        set: ($el, field, value, dataKey)=>($el.prop(field) !== value) && $el.prop(field, value)
      },
      data: {
        get: ($el, field, dataKey)=>$el.data(field),
        set: ($el, field, value, dataKey)=>($el.data(field) !== value) && $el.data(field, value)
      },
      attr: {
        get: ($el, field, dataKey)=>$el.attr(field),
        set: ($el, field, value, dataKey)=>($el.attr(field) !== value) && $el.attr(field, value)
      }
    },
